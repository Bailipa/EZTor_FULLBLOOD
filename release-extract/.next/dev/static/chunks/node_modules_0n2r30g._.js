...
"[project]/node_modules/@wrksz/themes/dist/shared/chunk-eytb43pc.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// src/core/script.ts
function themeScript(storageKey, attribute, defaultTheme, enableSystem, enableColorScheme, forcedTheme, themes, value, target, storage, themeColors, initialTheme, disableTransitionOnChange) {
    if (disableTransitionOnChange) {
        const css = typeof disableTransitionOnChange === "string" ? disableTransitionOnChange : "none";
    ...
    if (forcedTheme) {
        ...
        theme = stored && (themes.includes(stored) || enableSystem && stored === "system") ? stored : defaultTheme;
    }
    if (theme === "system") {
    ...
    if (!el) return;
    const attrs = Array.isArray(attribute) ? attribute : [
        attribute
    ];
...
"[project]/node_modules/@wrksz/themes/dist/shared/chunk-he2ypr6d.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
var ThemeContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function useTheme() {
...
function ClientThemeProvider({ children, themes = DEFAULT_THEMES, forcedTheme, enableSystem = true, defaultTheme, attribute = "class", value: valueMap, target = "html", disableTransitionOnChange = false, storage = "localStorage", storageKey = "theme", enableColorScheme = true, themeColor, followSystem = false, onThemeChange, initialTheme }) {
    const resolvedDefault = defaultTheme ?? (enableSystem ? "system" : "light");
    const storeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(createThemeStore());
    const store = storeRef.current;
    const { getSnapshot, setTheme: setStoreTheme, setSystemTheme: setStoreSystemTheme } = store;
    const { theme, systemTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSyncExternalStore"])(store.subscribe, store.getSnapshot, store.getServerSnapshot);
    const resolvedTheme = forcedTheme ?? (theme === "system" || theme === undefined ? systemTheme : theme);
    const onThemeChangeRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(onThemeChange);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientThemeProvider.useEffect": ()=>{
            onThemeChangeRef.current = onThemeChange;
        }
    }["ClientThemeProvider.useEffect"]);
    const getTargetEl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClientThemeProvider.useCallback[getTargetEl]": ()=>{
    ...
    const applyToDom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClientThemeProvider.useCallback[applyToDom]": (resolved)=>{
            ...
            if (disableTransitionOnChange) {
                const transitionValue = typeof disableTransitionOnChange === "string" ? disableTransitionOnChange : "none";
                const style = document.createElement("style");
                style.textContent = `*,*::before,*::after{transition:${transitionValue}!important}`;
                document.head.appendChild(style);
                requestAnimationFrame({
                    "ClientThemeProvider.useCallback[applyToDom]": ()=>requestAnimationFrame({
                            "ClientThemeProvider.useCallback[applyToDom]": ()=>document.head.removeChild(style)
                        }["ClientThemeProvider.useCallback[applyToDom]"])
                }["ClientThemeProvider.useCallback[applyToDom]"]);
            }
            for (const attr of attrs){
                if (attr === "class") {
                    const toRemove = themes.flatMap({
                        "ClientThemeProvider.useCallback[applyToDom].toRemove": (t)=>(valueMap?.[t] ?? t).split(" ")
                    }["ClientThemeProvider.useCallback[applyToDom].toRemove"]);
                    el.classList.remove(...toRemove);
                    el.classList.add(...attrValue.split(" "));
                } else {
                    el.setAttribute(attr, attrValue);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientThemeProvider.useEffect": ()=>{
            ...
            if (forcedTheme) {
                ...
                const initial = !followSystem && stored && (themes.includes(stored) || enableSystem && stored === "system") ? stored : resolvedDefault;
                setStoreTheme(initial);
                applyToDom(initial === "system" ? sys ?? "light" : initial);
            }
            if (!mq) return;
            const handler = {
                "ClientThemeProvider.useEffect.handler": (e)=>{
            ...
            }["ClientThemeProvider.useEffect.handler"];
            mq.addEventListener("change", handler);
            return ({
                "ClientThemeProvider.useEffect": ()=>mq.removeEventListener("change", handler)
            })["ClientThemeProvider.useEffect"];
        }
    }["ClientThemeProvider.useEffect"], [
        forcedTheme,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ClientThemeProvider.useEffect": ()=>{
            ...
            return ({
                "ClientThemeProvider.useEffect": ()=>window.removeEventListener("storage", handler)
            })["ClientThemeProvider.useEffect"];
        }
    }["ClientThemeProvider.useEffect"], [
        storage,
    ...
    const setTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ClientThemeProvider.useCallback[setTheme]": (next)=>{
    ...
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(ThemeContext.Provider, {
        value: contextValue,
        children
    });
}
...
"[project]/node_modules/@wrksz/themes/dist/shared/chunk-yqcsa7ra.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wrksz$2f$themes$2f$dist$2f$shared$2f$chunk$2d$eytb43pc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@wrksz/themes/dist/shared/chunk-eytb43pc.js [app-client] (ecmascript)");
...
function ClientNextThemeProvider({ children, themes = DEFAULT_THEMES, forcedTheme, enableSystem = true, defaultTheme, attribute = "class", value: valueMap, target = "html", disableTransitionOnChange = false, storage = "localStorage", storageKey = "theme", enableColorScheme = true, nonce, onThemeChange, themeColor, followSystem = false, initialTheme }) {
    const resolvedDefault = defaultTheme ?? (enableSystem ? "system" : "light");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useServerInsertedHTML"])({
        "ClientNextThemeProvider.useServerInsertedHTML": ()=>/* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])("script", {
                dangerouslySetInnerHTML: {
                    __html: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wrksz$2f$themes$2f$dist$2f$shared$2f$chunk$2d$eytb43pc$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getScript"])({
                        storageKey,
                        attribute,
    ...
    }["ClientNextThemeProvider.useServerInsertedHTML"]);
    return /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsx"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wrksz$2f$themes$2f$dist$2f$shared$2f$chunk$2d$he2ypr6d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClientThemeProvider"], {
        themes,
        forcedTheme,
        enableSystem,
        defaultTheme,
...
//# sourceMappingURL=node_modules_0n2r30g._.js.map