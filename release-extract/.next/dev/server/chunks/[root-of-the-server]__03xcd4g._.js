...
async function POST(req) {
    ...
    try {
        ...
        const { results } = body;
        console.log('Results to sync:', results?.length, results?.slice(0, 2));
        ...
        for (const wordData of results){
            if (wordData && wordData.word) {
                try {
                    console.log('Attempting to save word:', wordData.word, JSON.stringify(wordData));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__03xcd4g._.js.map