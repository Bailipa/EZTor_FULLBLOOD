...
public class MainActivity extends Activity {
    ...
    private class ShareBridge {
         ...
         *  仅用 App 私有 cacheDir + FileProvider 暴露，无需任何存储权限。
         *  NO_WRAP + trim：data URL 里的 +/=/换行由 JS 侧已规整，避免解码报错。 */
        private Uri writeShareImage(String base64Image) throws Exception {
            ...
            byte[] bytes = android.util.Base64.decode(data.trim(), android.util.Base64.NO_WRAP);
