...
import { BarChart3, MessageSquare, Users, Languages, BookOpen, Database, ExternalLink, Zap, Download, Sparkles } from 'lucide-react'
...
const adminNavItems: SidebarNavItem[] = [
  ...
  { href: '/admin/ai', label: 'AI 询问统计', icon: Sparkles },
